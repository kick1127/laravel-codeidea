...
<div class="all-icons">
	...
	<ul><!--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		...
		<h2>코드아이디어 기본</h2>
		<li style="width:300px;"><i class="code-code" style="width:200px;"></i><span class="code">e90a</span></li>
		<li style="width:300px;"><i class="code-idea" style="width:200px;"></i><span class="code">e90b</span></li><br/>
		<li><i class="code-map"></i><span class="code">e900</span></li>
		<li><i class="code-nav"></i><span class="code">e901</span></li>
		<li><i class="code-upload"></i><span class="code">e902</span></li>
		<li><i class="code-a"></i><span class="code">e903</span></li>
		<li><i class="code-c"></i><span class="code">e904</span></li>
		<li><i class="code-d"></i><span class="code">e905</span></li>
		<li><i class="code-e"></i><span class="code">e906</span></li>
		<li><i class="code-e2"></i><span class="code">e907</span></li>
		<li><i class="code-i"></i><span class="code">e908</span></li>
		<li><i class="code-o"></i><span class="code">e909</span></li>		
	</ul>
