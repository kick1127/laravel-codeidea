...
class MasterController extends Controller
{
    ...
    {
        return view('admin.master.create-form', [
            'title'       => '회원관리',
            'currentMenu' => 'master',
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->redirectTo(route('admin.master.show', $member->code));
    }
    ...
    public function show(string $code)
    {
        ...
        return view('admin.master.edit-form', [
            'title'       => '회원관리',
            'currentMenu' => 'master',
            'data'        => $member,
        ]);
    ...
    public function update(Request $request, $code)
    {
        ...
        $member = User::where('code', $code)->where('type', 'admin')->first();
